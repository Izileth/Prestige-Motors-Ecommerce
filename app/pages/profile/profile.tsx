          ...
          <motion.div variants={fadeIn}>
            <Card className="border-0 shadow-sm rounded-none bg-white dark:bg-gray-900 hover:shadow-md transition-shadow">
              ...
              <CardContent>
                <div className="text-2xl font-medium text-gray-900 dark:text-gray-100">
                  R${" "}
                  {userStats?.valorTotalInventario?.toLocaleString("pt-BR") ||
                    0}
                </div>
                <p className="text-xs text-gray-500 dark:text-gray-500">
                  Em inventário
                        ...
                        <div>
                          ...
                          <p className="text-gray-900 dark:text-gray-100">
                            {currentUser?.dataNascimento
                              ? format(
                                  new Date(currentUser.dataNascimento),
                                  "dd/MM/yyyy",
                                  { locale: ptBR }
                                )
                              : "Não informada"}
                ...
                <Card className="border-0 shadow-sm bg-white dark:bg-gray-900">
                  ...
                  <CardContent>
                    <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
                      Ao excluir sua conta, você perderá acesso a todos os
                      veículos favoritados, histórico de compras e informações
                      pessoais.
                    </p>
                    <Dialog
                      ...
                      <DialogContent className="bg-white dark:bg-gray-900 border-0 shadow-lg">
                        ...
                        <DialogFooter>
                          ...
                          <Button
                            ...
                            disabled={
                              deleteConfirmation !== currentUser?.email ||
                              loading.delete
                            }
                  ...
                  {favorites && favorites.length > 0 ? (
                            ...
                            <div className="relative overflow-hidden group">
                              {vehicle.imagens && vehicle.imagens.length > 0 ? (
                                <div className="overflow-hidden">
                                  <img
                                    src={
                                      vehicle.imagens.find((img) => img.isMain)
                                        ?.url || vehicle.imagens[0].url
                                    }
                              ...
                              <div className="flex justify-between items-start">
                                ...
                                {vehicle.vendedor && (
                                  <div className="flex items-center gap-1 text-sm text-gray-500 dark:text-gray-400">
                                    ...
                                    <span>
                                      {vehicle.vendedor.id || "Localização"}
                                    </span>
                                  </div>
                                )}
                              </div>
                              ...
                              <div className="mt-2">
                                ...
                                {vehicle.parcelamento && (
                                  <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
                                    ...
                                    {formatPrice(
                                      (vehicle.precoPromocional ||
                                        vehicle.preco) / vehicle.parcelamento
                                    )}
                                  </p>
                                )}
                              </div>
                    ...
                    >
                      ...
                      <p className="text-gray-600 dark:text-gray-400 mb-6">
                        Você ainda não adicionou nenhum veículo aos seus
                        favoritos.
                      </p>
                      <Button
                        className="bg-black hover:bg-gray-900 text-white dark:bg-white dark:text-black dark:hover:bg-gray-100"
                            ...
                            >
                              ...
                              <TableCell className="text-right">
                                <Button
                                  ...
                                  size="sm"
                                  onClick={() =>
                                    (window.location.href = `/compras/${sale.id}`)
                                  }
                      ...
                      <ResponsiveContainer width="100%" height="100%">
                        <BarChart
                          ...
                          data={[
                            {
                              name: "Mínimo",
                              value: userStats?.precoMinimo || 0,
                            },
                            {
                              name: "Médio",
                              value: userStats?.precoMedio || 0,
                            },
                            {
                              name: "Máximo",
                              value: userStats?.precoMaximo || 0,
                            },
                          ]}
                          ...
                          data={[
                            {
                              ...
                              valor:
                                (userStats?.valorTotalInventario || 0) / 1000, // Em milhares
                            },
                          ]}
                          margin={{ top: 5, right: 30, left: 20, bottom: 5 }}
                        >
                        ...
                        <PieChart>
                          <Pie
                            data={[
                              {
                                name: "Mínimo",
                                value: userStats?.precoMinimo || 1,
                              },
                              {
                                name: "Médio",
                                value:
                                  (userStats?.precoMedio || 0) -
                                  (userStats?.precoMinimo || 0),
                              },
                              {
                                name: "Máximo",
                                value:
                                  (userStats?.precoMaximo || 0) -
                                  (userStats?.precoMedio || 0),
                              },
                            ]}
                            cx="50%"
                      ...
                      <ResponsiveContainer width="100%" height="100%">
                        <LineChart
                          data={[
                            {
                              name: "Mínimo",
                              valor: userStats?.precoMinimo || 0,
                            },
                            {
                              name: "Médio",
                              valor: userStats?.precoMedio || 0,
                            },
                            {
                              name: "Máximo",
                              valor: userStats?.precoMaximo || 0,
                            },
                          ]}
                          margin={{ top: 5, right: 30, left: 20, bottom: 5 }}
                        >
