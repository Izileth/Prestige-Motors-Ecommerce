        ...
        <div className="container mx-auto px-4">
            ...
            <div className="space-y-12 md:space-y-16">
                ...
                >
                    ...
                    className="relative bg-black dark:bg-white text-white dark:text-black py-2 px-4 md:px-6 text-sm md:text-base font-light tracking-wider z-10 overflow-hidden group"
