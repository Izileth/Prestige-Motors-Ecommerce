...
export function Banner() {
    ...
    return (
        ...
        className="border-b border-gray-100 dark:border-gray-900 bg-white dark:bg-gray-950 text-gray-900 dark:text-gray-100 overflow-hidden"
        ...
        <div className="container mx-auto px-4 py-3 md:py-4 flex items-center justify-between relative">
            ...
            className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 transition-colors duration-300"
