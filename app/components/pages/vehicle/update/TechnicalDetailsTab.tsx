...
import { Settings, Tag, ArrowLeft, ArrowRight } from "lucide-react";
import type { VehicleFormValues } from "~/schemas/schema";
import {
  FuelType,
  TransmissionType,
  BodyType,
...
export function TechnicalDetailsTab({ onBack, onNext }: TechnicalDetailsTabProps) {
