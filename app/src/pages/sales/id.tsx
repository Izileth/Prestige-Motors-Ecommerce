...
const SaleDetailPage = () => {
  ...
  const { currentSale, fetchSaleById, loadingStates, updateSale } = useSale();
  ...
  const formattedDate = useMemo(() => {
    ...
    return format(new Date(currentSale.dataVenda), "dd 'de' MMMM 'de' yyyy", {
      locale: ptBR,
    });
      ...
      <div className="flex flex-col items-center justify-center h-screen space-y-4">
        <div className="text-center">
          ...
          <p className="text-gray-600 mt-2">
            A venda solicitada não foi encontrada ou você não tem permissão para
            acessá-la.
          </p>
        </div>
          ...
          <div className="w-full space-y-4">
            ...
            <div className="flex flex-wrap gap-3">
              <Button
                ...
                disabled={
                  loadingStates.updating || currentSale.status === "CONCLUIDA"
                }
                variant={
                  currentSale.status === "CONCLUIDA" ? "default" : "outline"
                }
              >
