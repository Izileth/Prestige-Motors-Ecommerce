...
export default function VehicleDetails({ loaderData, vehicleFromLoader }: { vehicleFromLoader?: Vehicle | undefined; loaderData?: any }) {
    return <VehicleDetailsPage vehicleFromLoader={loaderData?.vehicle || vehicleFromLoader} />;
}