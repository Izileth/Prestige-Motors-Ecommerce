...
export default [
    ...
    route("vehicles/user", "routes/vehicles/user/list.tsx"),

    route("vehicles", "routes/vehicles/vehicle.tsx"),
    route("vehicles/:slug", "routes/vehicles/[slug]/index.tsx"),
    route("vehicles/create", "routes/vehicles/create/create.tsx"),
    route("vehicles/edit/:id", "routes/vehicles/edit/edit.tsx"),

    route("vehicles/search", "routes/search/search.tsx"),

    route("vehicles/select", "routes/vehicles/category/category.tsx"),
    
    
    route("vehicles/negotiations", "routes/vehicles/negociation/negociation.tsx"),
    route("vehicles/negotiations/:id", "routes/vehicles/negociation/id.tsx"),
